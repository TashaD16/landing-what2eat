  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-6 flex h-16 items-center justify-between">
        ...
        {/* Mobile hamburger */}
        <button
          className="md:hidden p-2 rounded text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
      ...
      >
        <div className="border-t dark:border-gray-800 bg-white dark:bg-gray-900 px-6 py-4 flex flex-col gap-4 text-sm font-medium text-gray-700 dark:text-gray-300">
          <a href="#features" onClick={close} className="hover:text-primary transition-colors">{t.nav.features}</a>
          <a href="#how-it-works" onClick={close} className="hover:text-primary transition-colors">{t.nav.howItWorks}</a>
          <a href="#pricing" onClick={close} className="hover:text-primary transition-colors">{t.nav.pricing}</a>
