    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          {/* About */}
          <div>
            <h4 className="font-[family-name:var(--font-nunito)] text-white font-bold mb-4">{t.footer.about.heading}</h4>
            <p className="text-sm leading-relaxed">{t.footer.about.text}</p>
          </div>
